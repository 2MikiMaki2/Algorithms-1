...
public class KdTree {
    ...
    /**
     * Coding insert was the most challenging part of this assignment because I originally coded it
     * as one would a basic BST, then later on I realized that I should re-code it to properly
     * assign RectHV to each node that is inserted. That took time and was confusing.
     */
